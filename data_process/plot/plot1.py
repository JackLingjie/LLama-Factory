...
# 绘制各列随 Loss 分母变化的曲线  
columns_to_plot = ['TA Text', 'TA Image',"Arena-Hard"]  

markers = ['o', 's', '^', 'd', 'x']  # 定义每条线的标记样式  
colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd']  # 定义每条线的颜色  
...
plt.title('Llama3.1-8B-Instruct TA Scores vs w2:w1 Ratio', fontsize=16)  # 改进后的标题  
...
# 保存图表为高分辨率的PDF文件  
plt.savefig('ta_scores_vs_w2_w1_ratio.pdf', dpi=300, bbox_inches='tight')  
