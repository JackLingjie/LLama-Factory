...
FORCE_TORCHRUN=1 llamafactory-cli train bash_script/reason/reason_min.yaml
FORCE_TORCHRUN=1 llamafactory-cli train bash_script/reason/reason_random.yaml
